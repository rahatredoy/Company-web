 ...
 *
 * The API sanitises before it stores and again before it sends. This is defence
 * in depth: it is the last thing between an admin-authored page and the
 * customer's browser, and it assumes the layers above it have failed.
 *
