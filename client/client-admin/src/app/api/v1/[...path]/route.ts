 ...
 *
 * On a connected custom domain the panel has no per-store API hostname to call,
 ...
 * panel calls the API directly with `X-Store-Slug`, and a path this app does
 * not serve should not pretend to.
 *
 * A deliberate copy lives in `client-store/src/app/api/v1/[...path]/route.ts`.
 */
