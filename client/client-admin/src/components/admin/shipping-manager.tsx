            ...
            <div className="space-y-4 py-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Field label="Free above" htmlFor="m-free" hint="Optional order subtotal.">
                  <Input id="m-free" name="freeAboveSubtotal" defaultValue={methodDraft?.method?.freeAboveSubtotal ?? ''} />
                </Field>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <Field label="Fastest (days)" htmlFor="m-min">
                  <Input id="m-min" name="estimatedDaysMin" type="number" min={0} defaultValue={methodDraft?.method?.estimatedDaysMin ?? ''} />
                </Field>
                <Field label="Slowest (days)" htmlFor="m-max">
                  <Input id="m-max" name="estimatedDaysMax" type="number" min={0} defaultValue={methodDraft?.method?.estimatedDaysMax ?? ''} />
                </Field>
              </div>
