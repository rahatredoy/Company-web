...
/**
 * The same stamp as formatDateTime without the year, while the year is the
 * current one — for cells that already carry a dated line above them, where
 * repeating "2026" costs width and says nothing.
 */
